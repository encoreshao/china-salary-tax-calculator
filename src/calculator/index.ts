...
export default class Salary implements ICalculateData {
  ...
  insuranceAndFundRate: IInsuranceAndFund = {
    ...
    supplementaryFund: 0.0, // 补充公积金 5%
  };
  insuranceAndFundRateOfCompany: IInsuranceAndFund = {
    pension: 0.16, // 养老保险 公司缴费费率为16%;
    medicalInsurance: 0.105, // 医疗保险 公司缴费比例为10.5%;
    unemploymentInsurance: 0.005, // 失业保险 公司缴费比例为0.5%;
  ...
  housingFundRange: IHousingFundRange = { min: 2590, max: 36549 }; // 公积金计算上下限
